...
module erode_cv_xferode_128_128_1_0_1_0_129_3_3_Pipeline_Col_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        erode_in_data24_dout,
        erode_in_data24_num_data_valid,
        erode_in_data24_fifo_cap,
        erode_in_data24_empty_n,
        erode_in_data24_read,
        erode_out_data25_din,
        erode_out_data25_num_data_valid,
        erode_out_data25_fifo_cap,
        erode_out_data25_full_n,
        erode_out_data25_write,
        img_width,
        buf_V_2_address0,
        buf_V_2_ce0,
        buf_V_2_q0,
...
output   ap_idle;
output   ap_ready;
input  [7:0] erode_in_data24_dout;
input  [1:0] erode_in_data24_num_data_valid;
input  [1:0] erode_in_data24_fifo_cap;
input   erode_in_data24_empty_n;
output   erode_in_data24_read;
output  [7:0] erode_out_data25_din;
input  [1:0] erode_out_data25_num_data_valid;
input  [1:0] erode_out_data25_fifo_cap;
input   erode_out_data25_full_n;
output   erode_out_data25_write;
...
reg ap_idle;
reg erode_in_data24_read;
reg erode_out_data25_write;
reg buf_V_2_ce0;
...
wire   [0:0] cmp_i_i142_i_read_reg_606;
...
reg    ap_ready_int;
reg    erode_in_data24_blk_n;
wire    ap_block_pp0_stage0;
reg    erode_out_data25_blk_n;
...
reg   [7:0] erode_in_data24_read_reg_639;
wire   [63:0] conv_i99_i_fu_369_p1;
reg   [63:0] conv_i99_i_reg_646;
...
wire   [0:0] icmp_ln1027_3_fu_436_p2;
reg   [0:0] icmp_ln1027_3_reg_704;
...
wire   [0:0] icmp_ln1027_6_fu_497_p2;
reg   [0:0] icmp_ln1027_6_reg_732;
...
wire   [0:0] icmp_ln1027_9_fu_546_p2;
reg   [0:0] icmp_ln1027_9_reg_754;
...
wire   [0:0] icmp_ln1027_2_fu_422_p2;
wire   [7:0] max_V_13_fu_458_p3;
wire   [0:0] icmp_ln1027_4_fu_463_p2;
wire   [0:0] icmp_ln1027_5_fu_487_p2;
wire   [7:0] max_V_17_fu_508_p3;
wire   [0:0] icmp_ln1027_7_fu_513_p2;
...
erode_cv_xfExtractPixels_1_1_0_s src_buf_temp_copy_extract_V_0_xfExtractPixels_1_1_0_s_fu_286(
...
erode_cv_xfExtractPixels_1_1_0_s src_buf_temp_copy_extract_V_0_4_xfExtractPixels_1_1_0_s_fu_292(
...
erode_cv_xfExtractPixels_1_1_0_s src_buf_temp_copy_extract_V_0_3_xfExtractPixels_1_1_0_s_fu_298(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_359)) begin
        if (((icmp_ln1027_1_fu_358_p2 == 1'd0) & (icmp_ln1027_fu_346_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_buf_cop_V_0_reg_253 <= 8'd255;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_359)) begin
        if (((icmp_ln1027_1_fu_358_p2 == 1'd0) & (icmp_ln1027_fu_346_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_buf_cop_V_1_0_reg_275 <= 8'd255;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_359)) begin
        if (((icmp_ln1027_1_fu_358_p2 == 1'd0) & (icmp_ln1027_fu_346_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_buf_cop_V_3_reg_264 <= 8'd255;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        icmp_ln1027_9_reg_754 <= icmp_ln1027_9_fu_546_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        conv_i99_i_reg_646[12 : 0] <= conv_i99_i_fu_369_p1[12 : 0];
...
always @ (posedge ap_clk) begin
    if (((ap_predicate_op50_read_state2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        erode_in_data24_read_reg_639 <= erode_in_data24_dout;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1027_reg_631_pp0_iter4_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        icmp_ln1027_3_reg_704 <= icmp_ln1027_3_fu_436_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1027_reg_631_pp0_iter6_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        icmp_ln1027_6_reg_732 <= icmp_ln1027_6_fu_497_p2;
...
always @ (*) begin
    if ((1'b1 == ap_condition_655)) begin
        ...
        end else if ((cmp_i_i142_i_read_reg_606 == 1'd0)) begin
            buf_V_1_address1 = conv_i99_i_fu_369_p1;
        end else begin
            buf_V_1_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((((cmp_i_i142_i == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((cmp_i_i142_i_read_reg_606 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        buf_V_1_ce1 = 1'b1;
    end else begin
        buf_V_1_ce1 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_655)) begin
        if ((cmp_i_i142_i == 1'd1)) begin
            buf_V_1_d1 = erode_in_data24_read_reg_639;
        end else if ((cmp_i_i142_i_read_reg_606 == 1'd0)) begin
            buf_V_1_d1 = 8'd255;
        end else begin
            buf_V_1_d1 = 'bx;
...
always @ (*) begin
    if ((1'b1 == ap_condition_659)) begin
        if ((cmp_i_i142_i == 1'd1)) begin
            ...
            buf_V_2_address1 = conv_i99_i_fu_369_p1;
        end else begin
            buf_V_2_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((~(p_cast_read_reg_610 == 2'd0) & ~(p_cast_read_reg_610 == 2'd1) & (cmp_i_i142_i == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001)) | (~(p_cast_read_reg_610 == 2'd0) & ~(p_cast_read_reg_610 == 2'd1) & (cmp_i_i142_i_read_reg_606 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        buf_V_2_ce1 = 1'b1;
    end else begin
        buf_V_2_ce1 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_659)) begin
        if ((cmp_i_i142_i == 1'd1)) begin
            buf_V_2_d1 = erode_in_data24_read_reg_639;
        end else if ((cmp_i_i142_i_read_reg_606 == 1'd0)) begin
            buf_V_2_d1 = 8'd255;
        end else begin
            buf_V_2_d1 = 'bx;
...
always @ (*) begin
    if ((1'b1 == ap_condition_662)) begin
        if ((cmp_i_i142_i == 1'd1)) begin
            ...
            buf_V_address1 = conv_i99_i_fu_369_p1;
        end else begin
            buf_V_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((((cmp_i_i142_i == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((cmp_i_i142_i_read_reg_606 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        buf_V_ce1 = 1'b1;
    end else begin
        buf_V_ce1 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_662)) begin
        if ((cmp_i_i142_i == 1'd1)) begin
            buf_V_d1 = erode_in_data24_read_reg_639;
        end else if ((cmp_i_i142_i_read_reg_606 == 1'd0)) begin
            buf_V_d1 = 8'd255;
        end else begin
            buf_V_d1 = 'bx;
...
always @ (*) begin
    if (((ap_predicate_op50_read_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        erode_in_data24_blk_n = erode_in_data24_empty_n;
    end else begin
        erode_in_data24_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln1031_reg_653_pp0_iter9_reg == 1'd0) & (erode_out_data25_full_n == 1'b0) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((ap_predicate_op50_read_state2 == 1'b1) & (erode_in_data24_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln1031_reg_653_pp0_iter9_reg == 1'd0) & (erode_out_data25_full_n == 1'b0) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((ap_predicate_op50_read_state2 == 1'b1) & (erode_in_data24_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln1031_reg_653_pp0_iter9_reg == 1'd0) & (erode_out_data25_full_n == 1'b0) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((ap_predicate_op50_read_state2 == 1'b1) & (erode_in_data24_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state10_pp0_stage0_iter9 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state11_pp0_stage0_iter10 = ((icmp_ln1031_reg_653_pp0_iter9_reg == 1'd0) & (erode_out_data25_full_n == 1'b0));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op50_read_state2 == 1'b1) & (erode_in_data24_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_condition_655 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd1) & (1'b0 == ap_block_pp0_stage0));
end

always @ (*) begin
    ap_condition_659 = (~(p_cast_read_reg_610 == 2'd0) & ~(p_cast_read_reg_610 == 2'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0));
end

always @ (*) begin
    ap_condition_662 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1027_1_reg_635_pp0_iter1_reg == 1'd1) & (icmp_ln1027_reg_631_pp0_iter1_reg == 1'd0) & (p_cast_read_reg_610 == 2'd0) & (1'b0 == ap_block_pp0_stage0));
end
...
always @ (*) begin
    ap_predicate_op50_read_state2 = ((cmp_i_i142_i == 1'd1) & (icmp_ln1027_1_reg_635 == 1'd1) & (icmp_ln1027_reg_631 == 1'd0));
end

assign buf_V_1_addr_gep_fu_212_p3 = conv_i99_i_fu_369_p1;

assign buf_V_1_address0 = conv_i99_i_reg_646;

assign buf_V_2_addr_gep_fu_219_p3 = conv_i99_i_fu_369_p1;

assign buf_V_2_address0 = conv_i99_i_reg_646;

assign buf_V_addr_gep_fu_205_p3 = conv_i99_i_fu_369_p1;

assign buf_V_address0 = conv_i99_i_reg_646;

assign cmp_i_i142_i_read_reg_606 = cmp_i_i142_i;

assign col_V_2_fu_352_p2 = (ap_sig_allocacmp_col_V_1 + 13'd1);

assign conv_i99_i_fu_369_p1 = col_V_1_reg_625_pp0_iter1_reg;

assign erode_out_data25_din = ((icmp_ln1027_9_reg_754[0:0] == 1'b1) ? src_buf_temp_copy_extract_V_0_4_reg_692_pp0_iter9_reg : max_V_20_reg_749);

assign icmp_ln1027_1_fu_358_p2 = ((zext_ln1027_fu_342_p1 < img_width) ? 1'b1 : 1'b0);

assign icmp_ln1027_2_fu_422_p2 = ((max_V_fu_84 > max_V_2_fu_96) ? 1'b1 : 1'b0);

assign icmp_ln1027_3_fu_436_p2 = ((max_V_11_fu_428_p3 > src_buf_temp_copy_extract_V_0_xfExtractPixels_1_1_0_s_fu_286_ap_return) ? 1'b1 : 1'b0);

assign icmp_ln1027_4_fu_463_p2 = ((max_V_13_fu_458_p3 > max_V_1_fu_88) ? 1'b1 : 1'b0);

assign icmp_ln1027_5_fu_487_p2 = ((max_V_14_reg_721 > src_buf_temp_med_apply_V_6_reg_709) ? 1'b1 : 1'b0);

assign icmp_ln1027_6_fu_497_p2 = ((max_V_15_fu_491_p3 > src_buf_temp_copy_extract_V_0_3_reg_715) ? 1'b1 : 1'b0);

assign icmp_ln1027_7_fu_513_p2 = ((max_V_17_fu_508_p3 > ret_fu_92) ? 1'b1 : 1'b0);

assign icmp_ln1027_8_fu_536_p2 = ((max_V_18_reg_743 > src_buf_temp_med_apply_V_7_reg_737) ? 1'b1 : 1'b0);

assign icmp_ln1027_9_fu_546_p2 = ((max_V_20_fu_540_p3 > src_buf_temp_copy_extract_V_0_4_reg_692_pp0_iter8_reg) ? 1'b1 : 1'b0);
...
assign max_V_11_fu_428_p3 = ((icmp_ln1027_2_fu_422_p2[0:0] == 1'b1) ? max_V_2_fu_96 : max_V_fu_84);

assign max_V_13_fu_458_p3 = ((icmp_ln1027_3_reg_704[0:0] == 1'b1) ? src_buf_temp_copy_extract_V_0_reg_687 : max_V_11_reg_699);

assign max_V_14_fu_469_p3 = ((icmp_ln1027_4_fu_463_p2[0:0] == 1'b1) ? max_V_1_fu_88 : max_V_13_fu_458_p3);

assign max_V_15_fu_491_p3 = ((icmp_ln1027_5_fu_487_p2[0:0] == 1'b1) ? src_buf_temp_med_apply_V_6_reg_709 : max_V_14_reg_721);

assign max_V_17_fu_508_p3 = ((icmp_ln1027_6_reg_732[0:0] == 1'b1) ? src_buf_temp_copy_extract_V_0_3_reg_715_pp0_iter7_reg : max_V_15_reg_727);

assign max_V_18_fu_519_p3 = ((icmp_ln1027_7_fu_513_p2[0:0] == 1'b1) ? ret_fu_92 : max_V_17_fu_508_p3);

assign max_V_20_fu_540_p3 = ((icmp_ln1027_8_fu_536_p2[0:0] == 1'b1) ? src_buf_temp_med_apply_V_7_reg_737 : max_V_18_reg_743);
...
always @ (posedge ap_clk) begin
    conv_i99_i_reg_646[63:13] <= 51'b000000000000000000000000000000000000000000000000000;
end

endmodule //erode_cv_xferode_128_128_1_0_1_0_129_3_3_Pipeline_Col_Loop
