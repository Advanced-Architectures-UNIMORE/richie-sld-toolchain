...
module color_detect_Mat2AxiStream (
...
wire   [31:0] entry_proc_U0_rows_c_din;
...
wire    MatStream2AxiStream_U0_imgOutput_data7_read;
...
color_detect_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
color_detect_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
color_detect_MatStream2AxiStream MatStream2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .imgOutput_data7_read(MatStream2AxiStream_U0_imgOutput_data7_read),
...
color_detect_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
color_detect_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
color_detect_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign MatStream2AxiStream_U0_ap_start = last_blk_width_channel_empty_n;

assign ap_done = MatStream2AxiStream_U0_ap_done;

assign ap_idle = (last_blk_pxl_width_1_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc_U0_ap_idle & MatStream2AxiStream_U0_ap_idle);
...
assign imgOutput_data7_read = MatStream2AxiStream_U0_imgOutput_data7_read;
...
endmodule //color_detect_Mat2AxiStream
