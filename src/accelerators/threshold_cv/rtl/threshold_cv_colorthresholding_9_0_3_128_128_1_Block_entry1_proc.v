...
module threshold_cv_colorthresholding_9_0_3_128_128_1_Block_entry1_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [15:0] img_height_fu_36_p1;
wire   [15:0] img_width_fu_40_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (p_src_mat_cols_empty_n == 1'b0) | (p_src_mat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_0_preg <= img_height_fu_36_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (p_src_mat_cols_empty_n == 1'b0) | (p_src_mat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_1_preg <= img_width_fu_40_p1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (p_src_mat_cols_empty_n == 1'b0) | (p_src_mat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_0 = img_height_fu_36_p1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (p_src_mat_cols_empty_n == 1'b0) | (p_src_mat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_1 = img_width_fu_40_p1;
    end else begin
...
assign img_height_fu_36_p1 = p_src_mat_rows_dout[15:0];

assign img_width_fu_40_p1 = p_src_mat_cols_dout[15:0];

endmodule //threshold_cv_colorthresholding_9_0_3_128_128_1_Block_entry1_proc
