...
reg   [7:0] imgHelper3_data1221_read_reg_132;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        imgHelper3_data1221_read_reg_132 <= imgHelper3_data1221_dout;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((imgHelper3_data1221_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((imgHelper3_data1221_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (imgHelper3_data1221_empty_n == 1'b0);
end
...
assign buf_V_3_d1 = imgHelper3_data1221_read_reg_132;
