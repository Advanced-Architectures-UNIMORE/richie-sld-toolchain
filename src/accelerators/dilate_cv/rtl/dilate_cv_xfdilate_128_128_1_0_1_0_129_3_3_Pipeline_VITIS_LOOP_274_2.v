...
module dilate_cv_xfdilate_128_128_1_0_1_0_129_3_3_Pipeline_VITIS_LOOP_274_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] dilate_in_data24_read_reg_132;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        dilate_in_data24_read_reg_132 <= dilate_in_data24_dout;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((dilate_in_data24_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((dilate_in_data24_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (dilate_in_data24_empty_n == 1'b0);
end
...
assign buf_V_1_d1 = dilate_in_data24_read_reg_132;
...
endmodule //dilate_cv_xfdilate_128_128_1_0_1_0_129_3_3_Pipeline_VITIS_LOOP_274_2
