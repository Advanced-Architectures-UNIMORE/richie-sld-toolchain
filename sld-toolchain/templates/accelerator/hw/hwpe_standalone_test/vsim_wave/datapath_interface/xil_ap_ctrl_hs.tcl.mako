...
<%def name="vsim_waves_hwpe_datapath_adapter_xil_ap_ctrl_hs()">\

<%
# Global signals
%>

add wave -noupdate -group {HWPE ${acc_wr_target}} -group {hwpe_${acc_wr_target}_datapath_adapter} -group {xil_ap_ctrl_hs} -group {global} -label {clk_i} {/pulp_tb/dut/gen_clusters[0]/gen_cluster_sync/i_cluster/i_ooc/i_bound/hwpe_gen/hwpe_wrap_i/i_hwpe_top_wrap/i_${acc_wr_target}_top/i_engine/i_${acc_wr_target}_adapter/clk_i}
add wave -noupdate -group {HWPE ${acc_wr_target}} -group {hwpe_${acc_wr_target}_datapath_adapter} -group {xil_ap_ctrl_hs} -group {global} -label {rst_ni} {/pulp_tb/dut/gen_clusters[0]/gen_cluster_sync/i_cluster/i_ooc/i_bound/hwpe_gen/hwpe_wrap_i/i_hwpe_top_wrap/i_${acc_wr_target}_top/i_engine/i_${acc_wr_target}_adapter/rst_ni}
...
add wave -noupdate -group {HWPE ${acc_wr_target}} -group {hwpe_${acc_wr_target}_datapath_adapter} -group {xil_ap_ctrl_hs} -label {ctrl_i} {/pulp_tb/dut/gen_clusters[0]/gen_cluster_sync/i_cluster/i_ooc/i_bound/hwpe_gen/hwpe_wrap_i/i_hwpe_top_wrap/i_${acc_wr_target}_top/i_engine/i_${acc_wr_target}_adapter/ctrl_i}

<%
# Flag signals
%>

add wave -noupdate -group {HWPE ${acc_wr_target}} -group {hwpe_${acc_wr_target}_datapath_adapter} -group {xil_ap_ctrl_hs} -label {flags_o} {/pulp_tb/dut/gen_clusters[0]/gen_cluster_sync/i_cluster/i_ooc/i_bound/hwpe_gen/hwpe_wrap_i/i_hwpe_top_wrap/i_${acc_wr_target}_top/i_engine/i_${acc_wr_target}_adapter/flags_o}
