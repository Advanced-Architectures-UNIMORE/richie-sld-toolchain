...
'''
    ...
    Description:    This class collects the templates which comply with
                    ...
                    defined under:
                        ...
                        ==> 'richie-sld-toolchain/sld-toolchain/python/<component-libraries>/generator.py'
...
<%
# =====================================================================
# Title:        def_richie_api_pulp
# Type:         Template API
# Description:  Define RICHIE APIs.
# =====================================================================
%>

<%def name="def_richie_api_pulp()">\
...
void richie_init(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
int richie_activate(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_program(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_update_buffer_addr(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_compute(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_wait_eu(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_wait_polling(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
...
void richie_free(RICHIE_DEVICE_PTR richie, const int cluster_id, const int accelerator_id){
