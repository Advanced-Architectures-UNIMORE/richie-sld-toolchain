...
'''
    ...
    Description:    HeSoC interconnect between the host domain, clusters,
                    L2 memory, etc.
 ...
 *
 * Module: hesoc_interconnect.sv
 *
 */

package automatic hesoc_interconnect_pkg;
...
module hesoc_interconnect #(
  ...
  localparam int unsigned N_SLAVES = hesoc_interconnect_pkg::n_slaves(N_CLUSTERS);
  localparam int unsigned IDX_L2_MEM = N_CLUSTERS;
  localparam int unsigned IDX_RAB = IDX_L2_MEM + L2_N_PORTS;
  ...
  AXI_BUS #(
    .AXI_ADDR_WIDTH (AXI_AW),
    .AXI_DATA_WIDTH (AXI_DW),
    .AXI_ID_WIDTH   (hesoc_interconnect_pkg::oup_id_w(N_CLUSTERS, AXI_IW_INP)),
    .AXI_USER_WIDTH (AXI_UW)
