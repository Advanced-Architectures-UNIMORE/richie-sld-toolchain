...
#               class, once it reads the platform configuration specifications. 
#               'acc_config.cfg' is meant to be a setup file to pilot the 
#               generation of accelerator interfaces. This procedure is 
#               transparent to the user that approaches to the toolchain.
# =====================================================================
