...
package automatic pulp_pkg;
  // Addressing
  localparam int unsigned AXI_AW = hesoc_cfg_pkg::AXI_AW;
  // Clusters
  localparam int unsigned AXI_DW_CL = hesoc_cfg_pkg::AXI_DW;
  localparam int unsigned AXI_IW_CL_OUP = hesoc_cfg_pkg::AXI_IW_MST;
  localparam int unsigned AXI_IW_CL_INP = hesoc_cfg_pkg::AXI_IW_SLV;
  // HeSoC Bus
  localparam int unsigned AXI_IW_SB_INP = 3;
  localparam int unsigned AXI_UW = hesoc_cfg_pkg::AXI_UW;
  function int unsigned axi_iw_sb_oup(input int unsigned n_clusters);
    return hesoc_interconnect_pkg::oup_id_w(n_clusters, AXI_IW_SB_INP);
  endfunction
  // L2 Memory
  localparam int unsigned L2_SIZE = hesoc_cfg_pkg::L2_SIZE;
  localparam int unsigned L2_AMO_PRESENT = hesoc_cfg_pkg::L2_AMO_PRESENT;
  // Peripherals
...
module pulp import pulp_pkg::*; #(
  ...
  // i_hesoc_interconnect.cl_mst -> [cl_inp]
  ...
  AXI_BUS_ASYNC #(
    ...
    .AXI_ID_WIDTH   (AXI_IW_CL_INP),
    .AXI_USER_WIDTH (AXI_UW),
    .BUFFER_WIDTH   (hesoc_cfg_pkg::DC_BUF_W)
  ...
  // i_hesoc_interconnect.l2_mst -> [l2_mst]
  ...
  // i_hesoc_interconnect.rab_mst -> [rab_mst] -> [rab_mst_{req,resp}]
  ...
  // i_hesoc_interconnect.periph_mst -> [periph_mst]
  ...
  // i_hesoc_interconnect.mbox_host_mst -> [mbox_host] -> i_mailbox.host_slv
  AXI_BUS #(
    .AXI_ADDR_WIDTH (AXI_AW),
    .AXI_DATA_WIDTH (AXI_DW),
    .AXI_ID_WIDTH   (AXI_IW_SB_OUP),
  ...
  // i_hesoc_interconnect.mbox_pulp_mst -> [mbox_pulp] -> i_mailbox.dev_slv
  AXI_BUS #(
    .AXI_ADDR_WIDTH (AXI_AW),
    .AXI_DATA_WIDTH (AXI_DW),
    .AXI_ID_WIDTH   (AXI_IW_SB_OUP),
  ...
  for (genvar i = 0; i < N_CLUSTERS; i++) begin: gen_clusters
    ...
    if (hesoc_cfg_pkg::ASYNC) begin : gen_cluster_async
    ...
    //  .USER_WIDTH   (AXI_UW),
    //  .BUF_DEPTH    (hesoc_cfg_pkg::DMA_MAX_BURST_LEN)
    //) i_packer_cl_oup (
    //  .clk_i,
    //  .rst_ni,
