...
from templates.accelerator.sw.hwpe_system_hal.archi_hwpe.archi_hwpe import ArchiHwpe
from templates.accelerator.sw.hwpe_system_hal.hal_hwpe.hal_hwpe import HalHwpe
...
class HwpeSystemHal:
    ...
    def ArchiHwpe(self):
        print("\n[py] >> LibHWPE ~ Hardware Abstration Layer (archi)")
        return ArchiHwpe(
            temp_type = 'templates/accelerator/sw/hwpe_system_hal/archi_hwpe/',
    ...
    def HalHwpe(self):
        print("\n[py] >> LibHWPE ~ Hardware Abstration Layer (hal)")
        return HalHwpe(
            temp_type = 'templates/accelerator/sw/hwpe_system_hal/hal_hwpe/',
    ...
    def HwpeTbSw(self):
        print("\n[py] >> LibHWPE ~ Software testbench")
        return HwpeTbSw(
            temp_type = 'templates/accelerator/sw/hwpe_system_hal/hwpe_tb_sw/',
