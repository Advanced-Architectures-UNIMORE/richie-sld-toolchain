...
class Generator:
    ...
    def render(self, platform_design_knobs, template, extra_params=[]):
        ...
        string = target.render(
            ...
            # target FPGA-based HeSoC (deployment)
...
def generation(temp_obj, platform_design_knobs, emitter, descr, out_dir, extra_params=[None for _ in range(3)]):
    template = temp_obj
    out_target = Generator().render(platform_design_knobs, template, extra_params)
