...
class Generator:
    ...
    def render(self, platform_design_knobs, template, cl_id=0, extra_params=[]):
        ...
        string = target.render(
            ...
            # dma
            n_dma                           = platform_design_knobs.list_cl_dma[cl_id][0],
            cl_dma_max_n_reqs               = platform_design_knobs.list_cl_dma[cl_id][1],
            cl_dma_max_n_txns               = platform_design_knobs.list_cl_dma[cl_id][2],
            cl_dma_n_dma_streams            = platform_design_knobs.list_cl_dma[cl_id][3],
            cl_dma_max_burst_size           = platform_design_knobs.list_cl_dma[cl_id][4],
            # cluster data memory
