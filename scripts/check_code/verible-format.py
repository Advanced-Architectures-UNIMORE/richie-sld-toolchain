...
VERIBLE_ARGS = ["--inplace",
                "--try_wrap_long_lines"]

VERIBLE_ARGS.extend(["--formal_parameters_indentation=indent",
                "--named_parameter_indentation=indent",
                "--named_port_indentation=indent",
                "--port_declarations_indentation=indent"])

VERIBLE_ARGS.extend(["--class_member_variable_alignment=flush-left",
